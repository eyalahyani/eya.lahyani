...
<h3 align="center">Étudiante en Master Informatique, passionnée par le Full Stack Java/Angular et les microservices</h3>

- 🎓 Master en Informatique à Le Mans Université (2025-2027)  
...
- 🚗 **Application de gestion de parc automobile** (Stage fin d’études)  
  → Spring Boot, Angular, PostgreSQL, Keycloak  
- 🔧 **Application de gestion d’atelier mécanique**  
